...
import com.bevesttech.bevest.databinding.FragmentOwnerKtpDetailBinding
import com.bevesttech.bevest.utils.ViewModelFactory

class OwnerKtpDetailFragment : Fragment() {
    private var _binding: FragmentOwnerKtpDetailBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOwnerKtpDetailBinding.inflate(inflater, container, false)
        return binding.root
    }
